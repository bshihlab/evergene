...
clinical_events_all <- c("Progression-free interval" = "PFI", "Overall survival"= "OS", "Disease-specific survivial"= "DSS", "Disease-free interval"= "DFI")
...
#### Help messages
help_gene_input <- c(paste0("Genes can be formatted as <b>gene names</b> or <b>Ensembl ID</b>, separately by <b>spaces</b>, <b>commas</b> or <b>new lines</b>. ", 
...
help_rowMenu <- c("<b>Gene</b>: drop-down menu showing the input genes used in the analysis.", 
					"<b>Cancer type</b>: drop-down menu showing the input cancer types used in the analysis.", 
